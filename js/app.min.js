...
let slider_about = new Swiper('.develop-slider__container', {
...
let slider_present = new Swiper('.present-slider__container', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.present__item__next',
		prevEl: '.present__item__prev',
	},
	/*
	breakpoints: {
		320: {
